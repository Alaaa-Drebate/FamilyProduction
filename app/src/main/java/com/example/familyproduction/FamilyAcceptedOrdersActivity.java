...
public class FamilyAcceptedOrdersActivity extends AppCompatActivity {

    Toolbar mToolBar;

    FamilyAcceptedOrdersAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_family_accepted_orders);


        mToolBar = findViewById(R.id.toolbar);
        setSupportActionBar(mToolBar);
        mToolBar.setTitle(getResources().getString(R.string.accepted_deals));
    ...
    private void getNewOrders() {
        String url = "food_app/public/api/v1/family-carts";
                        ...
                        try {
                            ...
                            if (status == 1) {
                                ...
                                for (int i = 0; i < array1.length(); i++) {
                                    ...
                                    if (order.getStatus() == Constants.ORDER_STATUS_ACCEPTED)
                                        orders.add(order);
                                    orderDetails = "";
                                }

                                mAdapter = new FamilyAcceptedOrdersAdapter(FamilyAcceptedOrdersActivity.this, orders);
